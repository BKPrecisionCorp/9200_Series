...
powerSupply_9201.write("List:Func 1")       # We enable list mode, 0 is off, 1 is on
time.sleep(0.1)
powerSupply_9201.write("LIST:LOAD 0")       # Loads one of the 10 lists, input value is from 0 to 9. We load the 0th list.

powerSupply_9201.write("list:volt 1,10")
powerSupply_9201.write("list:volt 2,21")
powerSupply_9201.write("list:volt 3,3.33")
powerSupply_9201.write("list:volt 4,7")
powerSupply_9201.write("list:volt 5,60")

powerSupply_9201.write("list:curr 1,0.5")
powerSupply_9201.write("list:curr 2,2.3")
powerSupply_9201.write("list:curr 3,6")
powerSupply_9201.write("list:curr 4,6.5")
powerSupply_9201.write("list:curr 5,9.9999")

powerSupply_9201.write("list:time 1,0.5")
powerSupply_9201.write("list:time 2,2")
powerSupply_9201.write("list:time 3,1")
powerSupply_9201.write("list:time 4,0.8")   # Not some of these random values may trigger the power supplies power limit of 200W, which means the power supply will limit the values
powerSupply_9201.write("list:time 5,6")     # Here we fulfill the first 5 slots of the list with their respective voltage, current, and time values


powerSupply_9201.write("List:save 0")       # We save the list to slot 0
powerSupply_9201.write("List:time? 2")      # To make sure the list saved we look at slot 2 to see if it is consistant with what we wanted
...
powerSupply_9201.write("list:rep 3")        # Because our list is only 5 slots, we'll set it to repeat itself 3 times (0 - 65535)      
...
powerSupply_9201.write("trig")              # We send the trigger signal.
