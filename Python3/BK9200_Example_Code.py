...
print("This Script is made for the BK9200 Series Power Supplies")
...
powerSupply_9200.write("OUTP:STATE OFF")            # Disables Output
...
powerSupply_9200.write("CURR:level 0.5")            # Sets current output to 0.5 A
print("Output Current:", end=' ')
powerSupply_9200.write("CuRr:level?")               # Prints the current the Power Supply is set to
print(powerSupply_9200.read())
print("\n")
time.sleep(1)
print("Measured Current:", end=' ')
powerSupply_9200.write("measure:current?")          # Prints current the internal ammeter of the supply measures    (Should always be 0)
print(powerSupply_9200.read())
print("\n")

time.sleep(1)
print("Output Voltage: ")
powerSupply_9200.write("VOLT:level 12")             # Sets voltage output to 12 V
powerSupply_9200.write("voLT:LEV?")
print(powerSupply_9200.read())                      # Prints voltage the Power Supply is set to
print("\n")

time.sleep(1)
print("Measured Voltage:", end=' ')        
powerSupply_9200.write("meas:volt?")                # Prints voltage the internal voltmeter of the supply measures  (Should always be 0)
print(powerSupply_9200.read())
print("\n")
print("\n")
...
print("Measured Current:", end=' ')
powerSupply_9200.write("measure:current?")          # Prints current the internal ammeter of the supply measures
print(powerSupply_9200.read())
print("\n")

print("Measured Voltage:", end=' ')
powerSupply_9200.write("meas:volt?")                # Prints voltage the internal voltmeter of the supply measures
print(powerSupply_9200.read())
print("\n")
print("\n")
...
powerSupply_9200.write("curr:step 0.1;lev 5")       # Sets step size of current to 0.1 Amps
powerSupply_9200.write("volt:step 1;lev 30")        # Sets step size of voltage to 1 Volt
time.sleep(0.2)


for x in range(0, 80):                              # a FOR loop interating 80 times
    if x < 20:
       powerSupply_9200.write("curr:level up") 
       powerSupply_9200.write("volt:level down") 
       time.sleep(0.2)                              # increases voltage and current 20 steps
    elif x < 60:
       powerSupply_9200.write("curr:level down") 
...
time.sleep(1)
powerSupply_9200.write("OUTP:STATE OFF")            # Disables Output    
powerSupply_9200.write("curr:level 0")              # Resets Voltage and Current levels
powerSupply_9200.write("volt:level 0") 
time.sleep(1)

print("_____Creating List..._____")       
powerSupply_9200.write("List:Func 1")               # Set unit to list mode
time.sleep(0.1)
powerSupply_9200.write("LIST:LOAD 1")               # Loads one of the 10 lists, input value is from 0 to 9. This loads list 1 to be edited
...
for x in range(1, 152):                             # a FOR loop iterating 150 times (the max length of a list who's indices are from 1 to 151)
    if x < 21:
       powerSupply_9200.write("list:time %d,0.2" % (x))     # Writes a time value to X slot in the list. Notice how we write a variable to the list.
       voltageOutput = voltageCenter + (x - 1)
       powerSupply_9200.write("list:volt %d,%.3f" % (x, voltageOutput))     # Writes a voltage value to X slot in the list
       currentOutput = round((currentCenter - (x - 1)*0.1), 1)
       powerSupply_9200.write("list:curr %d,%.3f" % (x, currentOutput))     # Writes a current value to X slot in the list
    elif x < 61:
       powerSupply_9200.write("list:time %d,0.2" % (x))
       voltageOutput = (voltageCenter + 20) - (x - 21)
       powerSupply_9200.write("list:volt %d,%.3f" % (x, voltageOutput))
       currentOutput = round(((currentCenter - 2) + (x - 21)*0.1), 1)
       powerSupply_9200.write("list:curr %d,%.3f" % (x, currentOutput)) 
    elif x < 82:
       powerSupply_9200.write("list:time %d,0.2" % (x))
       ...
       powerSupply_9200.write("list:time %d,0" % (x))
       voltageOutput = 0
       powerSupply_9200.write("list:volt %d,0" % (x))
       currentOutput = 0
       powerSupply_9200.write("list:curr %d,0" % (x)) 
    print(x)
    print(voltageOutput)
    print(currentOutput)
...
time.sleep(2)
powerSupply_9200.write("List:save 1")               # We save the list to slot 1
powerSupply_9200.write("List:volt? 1")              # To make sure the list saved we look at slot 1 to see if it is consistant with what we wanted
print(powerSupply_9200.read())
powerSupply_9200.write("List:curr? 1") 
print(powerSupply_9200.read())
powerSupply_9200.write("List:time? 1") 
print(powerSupply_9200.read())
...
powerSupply_9200.write("trig")              # We send the trigger signal, when in list mode, the supply waits for a trigger signal to navigate the loaded list.
...
powerSupply_9200.write("List:Func 0")
powerSupply_9200.write("OUTP:STATE OFF")    # Disables and Resets    
powerSupply_9200.write("curr:level 0") 
powerSupply_9200.write("volt:level 0") 
powerSupply_9200.write("syst:LOC")          # Sets system to local mode
